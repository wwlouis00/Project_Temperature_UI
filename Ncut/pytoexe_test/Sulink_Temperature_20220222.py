...
if not os.path.isdir('./image'):
    ...
    os.mkdir('./image')
    print("Directory 'image' is established.")
...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def browsefile1(self):
        ...
        self.fname=[]
        self.fname = QFileDialog.getOpenFileName(self, '開啟txt檔案', 'C:\Program Files (x86)', 'csv files (*.csv)') # " C:\python\Learn_Python\Temperature" 是自己的電腦位置路徑
        if(self.fname[0]==""):
            print("no file")
        else:
    ...
    def take_picture1(self):
        ...
        plt.xlim(0, len(self.df.index))  # 設定圖範圍
        plt.ylim(0, 130)  # 設定圖範圍
        plt.savefig('image1/CH1.jpg')
        # ---------------CH2---------------------
        plt.figure(figsize=(3, 3), dpi=60, linewidth=0)
        plt.plot(self.CH_total, self.CH2_data, 'o-', color='orange', label="CH2_data")  # 紅
        plt.xlim(0, len(self.df.index))  # 設定圖範圍
        plt.ylim(0, 130)  # 設定圖範圍
        plt.savefig('image1/CH2.jpg')
        # ---------------CH3---------------------
        plt.figure(figsize=(3, 3), dpi=60, linewidth=0)
        plt.plot(self.CH_total, self.CH3_data, 'o-', color='yellow', label="CH3_data")  # 紅
        plt.xlim(0, len(self.df.index))  # 設定圖範圍
        plt.ylim(0, 130)  # 設定圖範圍
        plt.savefig('image1/CH3.jpg')
        # ---------------CH4---------------------
        plt.figure(figsize=(3, 3), dpi=60, linewidth=0)
        plt.plot(self.CH_total, self.CH4_data, 'o-', color='green', label="CH4_data")  # 紅
        plt.xlim(0, len(self.df.index))  # 設定圖範圍
        plt.ylim(0, 130)  # 設定圖範圍
        plt.savefig('image1/CH4.jpg')
        # ---------------CH5---------------------
        plt.figure(figsize=(3, 3), dpi=60, linewidth=0)
        plt.plot(self.CH_total, self.CH5_data, 'o-', color='#6F00FF', label="CH5_data")  # 紅
        plt.xlim(0, len(self.df.index))  # 設定圖範圍
...
"        }")
        ...
        #第二頁按鈕設定
        self.com_btn_opentxt.clicked.connect(self.browsefile1)
        self.com_btn_save.clicked.connect(self.save_log1)
        self.com_btn_clean.clicked.connect(self.clean_log1)
